    ...
    <div class="app-container">
        <div class="filter-container">
            ...
            <el-table :key="tableKey" v-loading="listLoading" :data="list" border fit highlight-current-row
                style="width: 100%">
                <el-table-column label="活动状态" prop="index" align="center" min-width="50">
                ...
                <el-table-column label="办理进度" prop="code" align="center">
                    <template slot-scope="{ row }">
                        <span>{{ row.code }}</span>
                    </template>
                </el-table-column>
                ...
                <el-table-column label="位置描述" prop="address" align="center">
                    <template slot-scope="{ row }">
