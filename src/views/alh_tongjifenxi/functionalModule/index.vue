    ...
    <div class="filter-container">
      ...
      <el-form :inline="true" :model="listQuery" class="demo-form-inline">
        <el-form-item label="案卷编号">
          <el-input v-model="listQuery.filter" placeholder="请输入案卷编号" />
        </el-form-item>
        <el-form-item label="案卷名称">
          <el-input v-model="listQuery.filter" placeholder="请输入案卷名称" />
        </el-form-item>
        <el-form-item label="案卷来源">
          <el-input v-model="listQuery.filter" placeholder="请输入案卷来源" />
        </el-form-item>
        <el-form-item>
